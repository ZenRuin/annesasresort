<main id="main-container">
    ...
    <section class="content" id="home">
        ...
        <div class="announcement-container container" id="announcement">
            ...
            <div class="announcement">
                <div class="announcement-body">
                    ...
                    <h3>Notice to all:</h3>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vero fugit sit minus cum pariatur!
                        Maiores quidem hic aut maxime ipsa reiciendis nesciunt magni distinctio voluptatem, eos nostrum
                        numquam optio eius.</p>
                </div>
            </div>
        </div>
        ...
        <div class="rates-container container-fluid d-flex flex-column justify-content-center align-items-center">
            ...
            <div class="rates row p-3 text-center">
                ...
                <div class="rooms col-lg-6 col-xl-4">
                    ...
                    <h6>Extended Hours:<br> (RM 1 - 6) ₱100.00/hour<br>(RM 7 & 9) ₱150.00/hour <br>(RM 8) ₱250.00/hour
                    </h6>
                </div>
            </div>
        </div>
        ...
        <div class="testimonial-container">
            ...
            <p class="testimonial">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quia repellendus, vitae
                suscipit culpa molestiae possimus voluptate consequuntur odit nulla saepe obcaecati dolorem laudantium
                praesentium aspernatur mollitia aperiam laborum rem cum commodi doloremque asperiores officia hic
                similique. Sint ad nobis quos?</p>
            <div class="user">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="flush-headingOne">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                aria-controls="flush-collapseOne">Can I make a reservation on the Phone?
                            </button>
                        </h2>

                        <div id="flush-collapseOne" class="accordion-collapse collapse"
                            aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlush">
                            <div class="accordion-body">Yes, you can and your reservation will be duly noted. But it
                                will be considered temporary and can be cancelled at any time if another guest makes a
                                confirmed reservation for the same date.</div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="flush-headingTwo">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                aria-controls="flush-collapseTwo">How do I make a confirmed reservation?
                            </button>
                        </h2>

                        <div id="flush-collapseTwo" class="accordion-collapse collapse"
                            aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlush">
                            <div class="accordion-body">You can send us a picture of your reservation receipt through
                                our Facebook Messenger page to help facilitate your reservations. Please present your
                                deposit receipt to the front desk upon check-in for billing purposes, or you can call
                                this number:(+639214496552).</div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="flush-headingThree">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                aria-controls="flush-collapseThree">What are your amenities?
                            </button>
                        </h2>

                        <div id="flush-collapseThree" class="accordion-collapse collapse"
                            aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlush">
                            <div class="accordion-body">Please check out the website at Annesas-Resort.Online.com for
                                more detailed information about the resort and its amenities and services. You can also
                                browse or message us through our Facebook page or through email at
                                annesasresort@gmail.com.</div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="flush-headingFour">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                aria-controls="flush-collapseFour">What do you offer your Guests?
                            </button>
                        </h2>

                        <div id="flush-collapseFour" class="accordion-collapse collapse"
                            aria-labelledby="flush-headingFour" data-bs-parent="#accordionFlush">
                            <div class="accordion-body">Our resort give our guests the best summer vacation experience
                                at the most affordable prices possible.</div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="flush-headingFive">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                aria-controls="flush-collapseFive">Do you have free WIFI?
                            </button>
                        </h2>

                        <div id="flush-collapseFive" class="accordion-collapse collapse"
                            aria-labelledby="flush-headingFive" data-bs-parent="#accordionFlush">
                            <div class="accordion-body">Yes, we have free WIFI in our main lobby and password access is
                                available upon request from our front desk staff.</div>
                        </div>
                    </div>
    ...
    <section class="content" id="about">
        <div class="about-container container">
            ...
            <div class="history-container mt-5" id="history">
                ...
                <div class="paragraph">
                    <p>The resort was established by its sole owner, a former seafarer working as a Restaurant Manager
                        on a renowned international crew ship for almost two (2) decades. Her passion for hospitality
                        combined with her dedication on providing a unique memorable experience with guest, inspired her
                        to established a resort. The owner driven by her own experiences of wanting to create lasting
                        memories with their loved ones without financial strain, designed the resort to cater families
                        and group of friends seeking an affordable yet enjoyable retreat. Located in the vibrant of Dao
                        Street, Annesas Resort officially opended its door in the summer of 2017. It started with two
                        pools, four tents and two bamboo huts. Despite its modest beginning, the resort quickly gained
                        popularity for it's clean facilities, warm hospitality and exceptional service. Believing in
                        continuous improvement and evolution, the owner added two more pools to the resort, bringing the
                        total of four. the pool was designed with a unique theme, providing guests with varied and
                        immersive experiences. Ten more rooms has been added to ensure guest has saw a place to relax
                        and rest. And recently, a boxing gym known as "Legal na Kamao Boxing Gym" is built as added
                        amenities with extra charge. This addition further enhanced the resort's appeal and set it apart
                        from its competitors. Annesas Resort look to the future it continues to honor it's past staying
                        true ti it's root while embracing new opportunity for growth and innovation. </p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="paragraph">
                        <p>We are Affordable Resort whose incredible family of associates puts the soul in hospitality
                            every day. The needs of our guests, associates and owners are in the forefront of everything
                            we do. Through authenticity and innovation, we create unique memorable experiences.</p>
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="paragraph">
                        <p>Proudly opening doors to the true spirit of a Destination Resort and true meaning of
                            Hospitality.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="terms-container" id="terms">
                ...
                <div class="terms-paragraph">
                    <div class="terms-intro">
                        <p>These terms and conditions (the “Terms and Conditions”) govern the use of annesa.phsite.tech
                            (the “Site”). This Site is owned and operated by Annesas Resort and Events Place. This Site
                            is an ecommerce website.</p>
                    ...
                    <p>All content published and made available on our Site is the property of Annesas Resort and Events
                        Place and the Site's creators. This includes, but is not limited to images, text, logos,
                        documents, downloadable files and anything that contributes to the composition of our Site.</p>
                    <div class="mini-title">
                        <h5>Acceptable Use</h5>
                    </div>
                    <p>As a user of our Site, you agree to use our Site legally, not to use our Site for illegal
                        purposes and not to:</p>
                    <ul>
                        <li>Violate the rights of other users of our Site;</li>
                        <li>Violate the intellectual property rights of the Site owners or any third party to the Site;
                        </li>
                    ...
                    <p>If we believe you are using our Site illegally or in a manner that violates these Terms and
                        ...
                        reserve the right to take any legal steps necessary to prevent you from accessing our Site.</p>
                    <div class="mini-title">
                        <h5>Accounts</h5>
                    </div>
                    ...
                    <div class="numbers">
                        <ol>
                            <li>You are solely responsible for your account and the security and privacy of your
                                account, including passwords or sensitive information attached to that account; and</li>
                            <li>All personal information you provide to us through your account is up to date, accurate,
                                and truthful and that you will update your personal information if it changes. </li>
                        </ol>
                    </div>
                    <p>We reserve the right to suspend or terminate your account if you are using our Site illegally or
                        if you violate these Terms and Conditions.</p>
                    <div class="mini-title">
                        <h5>Sale of Services</h5>
                    </div>
                    <p>These Terms and Conditions govern the sale of services available on our Site.<br>The following
                        services are available on our Site:</p>
                    <ul>
                        <li>Sparring Area;</li>
                    ...
                    <p>These Terms and Conditions apply to all the services that are displayed on our Site at the time
                        you access it. All information, descriptions, or Images that we provide about our services are
                        as accurate as possible. However, we are not legally bound by such information, descriptions, or
                        images as we cannot guarantee the accuracy of all services we provide. You agree to purchase
                        services from our Site at your own risk.</p>
                    <p>We reserve the right to modify, reject or cancel your order whenever it becomes necessary. If we
                        cancel your order and have already processed your payment, we will give you a refund equal to
                        the amount you paid. You agree that it is your responsibility to monitor your payment instrument
                        to verify receipt of any refund.</p>
                    <div class="mini-title">
                        <h5>Payments</h5>
                    </div>
                    ...
                    <p>When you provide us with your payment information, you authorize our use of and access to the
                        ...
                        authorize us to charge the amount due to this payment instrument.</p>
                    ...
                    <ul>
                        <li>The reservation fee will be fully refunded if the reservations are canceled 1 week before
                            the reserved schedule.</li>
                    </ul>
                    <div class="mini-title">
                        <h5>Consumer Protection Law</h5>
                    </div>
                    <p>Where any consumer protection legislation in your jurisdiction applies and cannot be excluded,
                        these Terms and Conditions will not limit your legal rights and remedies under that legislation.
                        These Terms and Conditions will be read subject to the mandatory provisions of that legislation.
                        If there is a conflict between these Terms and Conditions and that legislation, the mandatory
                        provisions of the legislation will apply.</p>
                    <div class="mini-title">
                        <h5>Links to Other Websites</h5>
                    </div>
                    <p>Our Site contains links to third party websites or services that we do not own or control. We are
                        not responsible for the content, policies, or practices of any third party website or service
                        linked to on our Site. It is your responsibility to read the terms and conditions and privacy
                        policies of these third party websites before using these sites.</p>
                    <div class="mini-title">
                        <h5>Limitation of Liability</h5>
                    </div>
                    <p>Annesa's Resort and Events Place and our directors, officers, agents, employees, subsidiaries,
                        and affiliates will not be liable for any actions, claims losses damages liabilities and
                        expenses including legal fees from your use of the Site.</p>
                    <div class="mini-title">
                        <h5>Indemnity</h5>
                    </div>
                    <p>Except where prohibited by law, by using this Site you indemnify and hold harmless Annesa's
                        Resort and Events Place and our directors, officers, agents, employees, subsidiaries, and
                        affiliates from any actions, claims, losses, damages, liabilities and expenses including legal
                        fees arising out of your use of our Site or your violation of these Terms and Conditions.</p>
                    <div class="mini-title">
                    ...
                    <p>Subject to any exceptions specified in these Terms and Conditions, if you and Annesa's Resort and
                        Events Place are unable to resolve any dispute through informal discussion, then you and
                        Annesa's Resort and Events Place agree to submit the issue before a mediator. The decision of
                        the mediator will not be binding. Any mediator must be a neutral party acceptable to both you
                        and Annesa's Resort and Events Place.</p>
                    <p>Notwithstanding any other provision in these Terms and Conditions, you and Annesa's Resort and
                        Events Place agree that you both retain the right to bring an action in small claims court and
                        to bring an action for injunctive relief or intellectual property infringement.</p>
                    <div class="mini-title">
                        <h5>Severability</h5>
                    </div>
                    ...
                    <p>These Terms and Conditions may be amended from time to time in order to maintain compliance with
                        ...
                        behave on our Site. We will notify users by email of changes to these Terms and Conditions or
            ...
            <div class="row my-5">
                <div class="container-input col-md-6">
                    <form class="form-container" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="emailcontact" aria-describedby="emailHelp"
                ...
                <div class="contact-map col-md-6">
                    <iframe class="map-iframe"
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3858.71581088126!2d121.13154580000001!3d14.7286526!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3397bb195a8234af%3A0xe2ddd20c71e1c3ce!2sAnnesa&#39;s%20Resort!5e0!3m2!1sen!2sph!4v1718263313414!5m2!1sen!2sph"
            ...
            <div class="book-row row d-flex justify-content-between">
                <div class="book col-lg-6 col-xl-6 col-12 row">
                    <div class="book-details col-md-6">
                        ...
                        <button class="btn btn-primary reserve-btn" data-bs-toggle="modal" data-bs-target="#loginModal">
                            Reserve
                        </button>
                    </div>
                    <div class="book-image col-md-6">
